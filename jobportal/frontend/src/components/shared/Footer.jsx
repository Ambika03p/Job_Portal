    ...
    <footer className="bg-[#00040A] text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */ }
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#535bf2]">About JobPlateau</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/" className="hover:text-[#535bf2] transition">
                  About Us
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/ambika-03p/" className="hover:text-[#535bf2] transition" aria-label="LinkedIn">
                <Linkedin className="h-5 w-5" />
              </a>
              <a href="https://www.instagram.com/whimsical_._soul/?hl=en" className="hover:text-[#535bf2] transition" aria-label="Instagram">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <p className="text-center text-gray-400">
            © { new Date().getFullYear() } JobPlateau. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
